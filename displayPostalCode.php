...
<head>
    ...
    <title>Display Postal Code</title>
...
<body>
    ...
    <div class="container">
        <p class="h2 mt-3">Display Postal Code</p>
        <p>You can display the specific postal Codes here.</p>
        <div class="card mt-3">

            <form action="./models/save-postal-code.php" method="POST">
                <div class="card-header">Display Postal Codes</div>
                <div class="card-body">
                    <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <select name="inp_ctymun" id="inp_ctymun" onchange="display_brgy(this.value)" onclick=" display_poscode(this.value)"
                                class="form-select">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <input disabled name="inp_postalcode" id="inp_postalcode" class="form-control">
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function display_poscode(citymunCode) {
        console.log(citymunCode);
        $.ajax({
            url: './models/ph-address.php',
            type: 'POST',
